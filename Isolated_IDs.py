...
print(filtered_df)
#print('done')
#print(filtered_df[['Id', 'gridcode', 'distance']])
# Putall rest in theloop
...
filtered_gridcode_df = filtered_df[filtered_df['gridcode'] == min_distance_gridcode]

# Find the FID of the row with the minimum distance within that filtered set
fid_of_min_value = filtered_gridcode_df.at[filtered_gridcode_df['distance'].idxmin(), 'Id']

print(fid_of_min_value)
...
## Need to update this for lowest on 2nd half
